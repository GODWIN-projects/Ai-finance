/*
  ...
  - You are about to drop the column `cleckUserId` on the `users` table. All the data in the column will be lost.
...
*/
-- DropIndex
DROP INDEX "users_cleckUserId_key";

-- AlterTable
ALTER TABLE "users" DROP COLUMN "cleckUserId",
